...
# For the next phase of this project I would like to add some variables for the moon, such as the phase and illumination as it can effect observing. I also can see a if statment being created that will alert the user if it is a full moon or new moon.
